...
@NgModule({
  declarations: [AdministratorComponent, SidebarComponent, HeaderComponent, NavTopComponent, AdminDashboardComponent, AdminChartComponent, AdminUserManagerComponent],
  imports: [
    CommonModule,
